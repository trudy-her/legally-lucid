import { S27_SECTION_HEADER } from './section27Data.js'
import {
  ContinueError,
  MultiSelectHint,
  QuestionNav,
...
export function S27QuestionScreen({
  question,
  value,
  onSelect,
  onToggle,
  ...
  const questionId = `s27-${question.id}-question`
  ...
  return (
    <main className="gate">
      <p className="gate__section-header">{S27_SECTION_HEADER}</p>
...
export function S27SectionCompleteScreen() {
  return (
    <main className="gate">
      <p className="gate__section-header">{S27_SECTION_HEADER}</p>
      <p className="gate__question">Section 27 complete.</p>
    </main>
  )
}
